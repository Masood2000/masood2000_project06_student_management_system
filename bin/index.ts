...
class Courses{
    coursesName:string[] = ["OOPS","Computer Architecture","DSA","TOA","CFP"]
    coursesPrice:number[] = [7500,8000,10000,120000,4000]
}
...
async function enrollNewStd(){
   ...
   let nm:string, id:number,bln:number,crss:string[]=[]
...
function getRandomInt():number {
  ...
  async function enrollCourse(std:Student){
    await inquirer.prompt([
        {
